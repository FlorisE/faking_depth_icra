...
sys.path.append('../')
from rgbd_dataloader import get_train_dataset, get_valid_dataset
...
MIN_CLIP=450
MAX_DEPTH=2000
STATS_PATH='dishwasher_rgbd_resnet_wineglass.obj'
BEST_CHECKPOINT_PATH='../data/checkpoints/dishwasherRGBD-resnet-wineglass-best'
LATEST_CHECKPOINT_PATH='../data/checkpoints/dishwasherRGBD-resnet-wineglass-latest'
LOGS='./logs/dishwasher_rgbd_resnet_wineglass/'
...
def train(num_epochs, 
    ...
    for epoch in range(start_from, num_epochs):
        ...
        for transparent_, opaque_ in dataset:
...
if __name__ == '__main__':
    generator_t2o, generator_o2t, discriminator_t, discriminator_o = get_resnet_networks(4, 4, 4, 4)
