...
MIN_CLIP=450
MAX_DEPTH=2000
STATS_PATH='dishwasher_depth2depth_unet_wineglass.obj'
BEST_CHECKPOINT_PATH='../data/checkpoints/dishwasher-depth2depth-unet-wineglass-best'
LATEST_CHECKPOINT_PATH='../data/checkpoints/dishwasher-depth2depth-unet-wineglass-latest'
LOGS='./logs/dishwasher_depth2depth_unet_wineglass/'
...
if __name__ == '__main__':
    generator_t2o, generator_o2t, discriminator_t, discriminator_o = get_networks(1, 1, 1, 1)
